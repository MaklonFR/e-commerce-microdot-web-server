...
let suhu = getRandomArbitrary(21, 25);
let kel = getRandomArbitrary(70, 80);
let tek = getRandomArbitrary (9000, 1012);

(function () {
let tanggalSekarang = new Date();
let formatLokal = tanggalSekarang.toLocaleDateString()
  ...
  var options = {
    ...
    labels: ["Linkedln", "Facebook", "Messanger", "Vimeo"],
    legend: {
      labels: {
  ...
  var IncomechrtchartEl = new ApexCharts(
    document.querySelector("#Incomechrt1"),
    income
  );
  ...
  var IncomechrtchartEl = new ApexCharts(
    document.querySelector("#Incomechrt2"),
    income
  );
  IncomechrtchartEl.render();
